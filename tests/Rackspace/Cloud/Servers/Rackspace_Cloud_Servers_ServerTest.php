...
/**
 * Test class for Rackspace_Cloud_Servers_Server.
 * Generated by PHPUnit on 2009-09-29 at 09:25:39.
 */
class Rackspace_Cloud_Servers_ServerTest extends RackspaceTestAbstract
{
    /**
     * @var    Rackspace_Cloud_Servers_Server
     * @access protected
     */
    protected $object;
    ...
    public function testGetFlavorBad() {
		...
		if ($servers == false) {
			// No servers listed
			$this->assertFalse($servers);
			$this->markTestSkipped("No Servers found.");
		} else {
			$this->assertType('array', $servers);
